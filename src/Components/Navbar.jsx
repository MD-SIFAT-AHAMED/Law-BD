    ...
    return (
        <>
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="flex space-x-5 text-lg px-1">
                <li><NavLink className={({isActive})=> isActive ? 'border-b-1 border-[#0EA106]' :''} to={'/'}>Home</NavLink></li>
                <li><NavLink className={({isActive})=> isActive ? 'border-b-1 border-[#0EA106]' :''} to={'/booking'}>My-Bookings</NavLink></li>
                <li><NavLink className={({isActive})=> isActive ? 'border-b-1 border-[#0EA106]' :''} to={'/blogs'}>Blogs</NavLink></li>
                <li><NavLink className={({isActive})=> isActive ? 'border-b-1 border-[#0EA106]' :''} to={'/contact'}>Contact Us</NavLink></li>
                </ul>
            </div>
